...
export default function  HomeNavbar(props: NavberProps) {
    const {cartItems, onAdd, onRemove, onDelete, onDeleteAll, setSignupOpen, setLoginOpen, handleCloseLogout, anchorEl, handleLogoutClick, handleLogoutRequest} =props;
